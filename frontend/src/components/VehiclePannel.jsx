...
const VehiclePannel = (props) => {
  return (
    <div>
        ...
        <div onClick={() => props.setConfirmRidePannel(true)} className=' w-full border-2 border-white active:border-black mb-2 p-5  rounded-xl flex items-center justify-between '>
        ...
        <div onClick={() => props.setConfirmRidePannel(true)}  className=' w-full border-2 mb-2 p-5  border-white active:border-black rounded-xl flex items-center justify-between '>
